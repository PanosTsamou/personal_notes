...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    ...
    cube_volume = calculate_the_volume(2)
    self.assertEqual(8, cube_volume)
    #add test code here
    #pass
  ...
  def test_reverse_string(self):
    string_for_testing = "hello world"
    results = string_reversed(string_for_testing)
    self.assertEqual("dlrow olleh",results)
    #add test code here
    #pass
  ...
  def test_fahrenheit_to_celsius(self):
    in_celsius = convert_F_to_Celsius(34)
    self.assertAlmostEqual(2,in_celsius)
    #add test code here
    pass
